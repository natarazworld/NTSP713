...
@Service("custService")
@Profile({"dev","test"})
public class MySQLCustomerMgmtServiceImpl implements CustomerMgmtService {
	@Autowired
   // @Qualifier("mysqlCustDAO")
	private  CustomerDAO dao;

	public MySQLCustomerMgmtServiceImpl() {
		System.out.println("MysqlCustomerMgmtServiceImpl:: 0-param constructor");
	}
