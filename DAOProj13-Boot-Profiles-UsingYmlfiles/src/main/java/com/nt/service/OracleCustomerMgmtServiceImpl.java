...
@Service("custService")
@Profile({"uat","prod"})
public class OracleCustomerMgmtServiceImpl implements CustomerMgmtService {
	@Autowired
   // @Qualifier("oraCustDAO")
	private  CustomerDAO dao;

	public OracleCustomerMgmtServiceImpl() {
		System.out.println("OracleCustomerMgmtServiceImpl:: 0-param constructor");
	}
